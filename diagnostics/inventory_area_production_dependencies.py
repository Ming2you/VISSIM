...
RUNTIME = {
    ...
    'diagnostics/physical_projection_support_635_proposal.json': '205 physical supports and 45-link positive unknown guard; production input despite historical filename',
...
if __name__ == '__main__':
    ...
    output = {
        ...
        'clean_checkout_limitations': [
            'The portable archive supplies all45 listed historical inputs and four fixed git source references; original evaluation/runs files and deep git history are unnecessary for the documented48-test subset.',
