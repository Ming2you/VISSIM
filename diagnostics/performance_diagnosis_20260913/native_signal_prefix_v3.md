...
- 실제 명령 일치 검증 완료 끝시각: None. 이번 후보 창 이후8850초까지 109초가 남는다. Parser 실패 시8741초까지도 검증됐다고 선언하지 않는다.
- 분석 소요 0.686초. 실패 stage: native_ldp_prefix. 모든 실패 상세·원본 SHA는 JSON에 보존했다.
