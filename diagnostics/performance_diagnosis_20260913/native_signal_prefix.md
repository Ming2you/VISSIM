...
- 실제 VSL 적용 readback: **None**; None행 / 예상 None행. 66 DSD ×4차종 ×59개 실제 명령 시각만 검사했다. 매초 검사를 추가하지 않았다.
...
- 분석 소요 0.352초. 실패 stage: native_ldp_prefix. 모든 실패 상세·원본 SHA는 JSON에 보존했다.
