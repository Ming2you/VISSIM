...
| ② 관측·매핑 | FW count helper의차로속성오류,동일차량의urban/ramp중복,off-ramp투영누락,짧은connector누락을재현. Ω635전체를지원분류하고새170개를실제단일하류근거로추가. 첫live실패후추가16개를신호이후실제회전·하류저장소근거로보완 | 실재오류. pure31초기상태와실패1050상태의Ω합계가관측과정확일치. 남은미확정29개양수는링크를명시하며거부. 수량보존이routing정확성의증명은아님 |
