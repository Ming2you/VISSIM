...
| --- | ---: | ---: | ---: | ---: | --- |
| `evaluation\runs\pstack_guarded_ladder_20260715\decisions_pstack_155w_guarded_seed13` | 0 | 1.000 | 3 | 21.361/23.632 | `recalibrate_components` |
| `evaluation\runs\pstack_guarded_ladder_20260715\decisions_pstack_190w_guarded_seed13` | 0 | 1.000 | 3 | 23.909/25.816 | `recalibrate_components` |
| `evaluation\runs\pstack_guarded_ladder_20260715\decisions_pstack_220w_guarded_seed13` | 0 | 1.000 | 3 | 24.090/25.551 | `recalibrate_components` |
