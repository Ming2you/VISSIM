...
**최신 재개점(2026-09-21)**: `docs/HANDOFF_20260921_gain_prediction.md`와 `diagnostics/handoff_20260921_spatial/README.md`를 먼저 읽는다. 차로별 공간 수송의30/150초 예측과 실제 미래 상류 경계만을 준 원인 분리 진단을 전달했다. 장기 개선이 일관되지 않아 정본에 승격하지 않았고 RM/VSL 순이득 보정은 NOT_QUALIFIED다. 누적 선택적 합류속도 수정·완료된3000초 RM 관측은 이전 `handoff_20260921_entry_speed`에 있다. 다음 작업과 복원 순서는 최신 README를 따른다.
