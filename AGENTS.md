...
2. **최신 현황·다른 컴퓨터에서의 재개**는 `docs/HANDOFF_20260913_controller_runtime.md` 를 먼저 읽는다. 8개 독립 미터, 실제 합류량 기준 N_UF, 80/50 수요, 8850초 중단 런의 TTT 비교와 남은 검증을 정리했다. `docs/HANDOFF_20260907_lcd1000_ramp_spillback.md`와 CLAUDE.md의 이전 수치·물리량 정의는 역사적 맥락이며 최신 사용자 합의와 충돌하면 최신 인계를 따른다.
