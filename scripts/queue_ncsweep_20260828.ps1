<#
2026-08-28. 본선 수요 sweep 1단계 — **무제어 9런**.
...
$arms = @(
  @{ name = "ncsweep_x16_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x16.inpx"; note = "무제어 · 본선 수요 x1.6 (첨두 7392 veh/h)" },
  @{ name = "ncsweep_x17_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x17.inpx"; note = "무제어 · 본선 수요 x1.7 (첨두 7854 veh/h)" },
  @{ name = "ncsweep_x18_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18.inpx"; note = "무제어 · 본선 수요 x1.8 (첨두 8316 veh/h)" },
  @{ name = "ncsweep_x19_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x19.inpx"; note = "무제어 · 본선 수요 x1.9 (첨두 8778 veh/h)" },
  @{ name = "ncsweep_x20_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x20.inpx"; note = "무제어 · 본선 수요 x2.0 (첨두 9240 veh/h)" },
  @{ name = "ncsweep_x21_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x21.inpx"; note = "무제어 · 본선 수요 x2.1 (첨두 9702 veh/h)" },
  @{ name = "ncsweep_x22_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22.inpx"; note = "무제어 · 본선 수요 x2.2 (첨두 10164 veh/h)" },
  @{ name = "ncsweep_x23_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x23.inpx"; note = "무제어 · 본선 수요 x2.3 (첨두 10626 veh/h)" },
  @{ name = "ncsweep_x24_20260828"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x24.inpx"; note = "무제어 · 본선 수요 x2.4 (첨두 11088 veh/h)" }
)
