<#
2026-08-28. 본선 수요 sweep 3단계 **후속** — x1.6 · x2.0 추가.
...
$arms = @(
  @{ name = "canon_fd3sw16_20260828"; tuning = "evaluation/configs/canon_fd3sw16_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x16.inpx"; note = "FD 2차 + x1.6 망 (붕괴 시작, 초과 8.1%) — 대조 6001.1" },
  @{ name = "canon_fd3sw20_20260828"; tuning = "evaluation/configs/canon_fd3sw20_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x20.inpx"; note = "FD 2차 + x2.0 망 (포화 진입, 초과 28.4%) — 대조 6869.4" }
)
