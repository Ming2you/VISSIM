<#
2026-08-31. 첫 환경(원본 망 · canon_fdfit3)에 ramp_arrival 교정만 얹는다. 단일변수.
...
$arms = @(
  @{ name = "canon_ramparr_20260831"; tuning = "evaluation/configs/canon_ramparr_20260831.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e.inpx"; note = "canon_fdfit3 + 램프별 실측 통과시간·cap — 대조 4657.8 / 무제어 4819.4" }
)
