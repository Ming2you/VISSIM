<#
2026-08-31. 세 수정을 **동시에** 넣는다 — 따로 켜면 셋 다 무의미했다.
...
$arms = @(
  @{ name = "canon_ramparr_gnedyn_20260831"; tuning = "evaluation/configs/canon_ramparr_gnedyn_20260831.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e.inpx"; note = "도착교정 + 미터링 GNE 안 + 동역학 4항(합류셀 보정 포함) — 대조 ramparr 4693.9 / fdfit3 4657.8" }
)
