<#
2026-08-28. movement 선언 phase 보정 팔 둘. 순차(VISSIM 동시 둘 불가).
...
$arms = @(
  @{ name = "canon_dpoff_20260828";    tuning = "evaluation/configs/canon_dpoff_20260828.json";    note = "dead_phase_beta_zero OFF (plantfix 대비 단일변수)" },
  @{ name = "canon_phasefix_20260828"; tuning = "evaluation/configs/canon_phasefix_20260828.json"; note = "위 + 선언 phase 보정 11건 (dpoff 대비 단일변수)" }
)
