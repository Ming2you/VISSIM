<#
2026-08-29. VSL 판정 6팔 — 재발사(앞 대기 큐가 timeout 으로 죽어 13시간 놓쳤다).
...
$arms = @(
  @{ name = "canon_fd3sw18_novsl_20260828"; tuning = "evaluation/configs/canon_fd3sw18_novsl_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18.inpx"; note = "x1.8 · VSL 끔(vsl_set=[120]) — 대조 6699.3(VSL 켬) / 6692.0(무제어)" },
  @{ name = "canon_fd3sw22_novsl_20260828"; tuning = "evaluation/configs/canon_fd3sw22_novsl_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22.inpx"; note = "x2.2 · VSL 끔 — 대조 7035.7(VSL 켬) / 6958.9(무제어)" },
  @{ name = "canon_fd3sw16_capdrop_20260828"; tuning = "evaluation/configs/canon_fd3sw16_capdrop_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x16.inpx"; note = "x1.6 · 용량강하 ON · alpha 0.1 — 무제어 대조 6001.1" },
  @{ name = "canon_fd3sw18_capdrop_20260828"; tuning = "evaluation/configs/canon_fd3sw18_capdrop_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18.inpx"; note = "x1.8 · 용량강하 ON · alpha 0.1 — 무제어 대조 6692.0" },
  @{ name = "canon_fd3sw20_capdrop_20260828"; tuning = "evaluation/configs/canon_fd3sw20_capdrop_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x20.inpx"; note = "x2.0 · 용량강하 ON · alpha 0.1 — 무제어 대조 6869.4" },
  @{ name = "canon_fd3sw22_capdrop_20260828"; tuning = "evaluation/configs/canon_fd3sw22_capdrop_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22.inpx"; note = "x2.2 · 용량강하 ON · alpha 0.1 — 무제어 대조 6958.9" }
)
