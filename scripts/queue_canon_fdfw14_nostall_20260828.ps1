<#
2026-08-28. canon_fdfw14 재발사 — **무진행 kill 끔**.
...
$arms = @(
  @{ name = "canon_fdfw14_20260828"; tuning = "evaluation/configs/canon_fdfw14_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fw14_ramp2.inpx"; note = "FD 재적합 + fw14_ramp2 망 — 무진행 kill 끔" }
)
