...
$arms = @(
  @{ name = "nc_out_x18_20260902"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18_rampbn.inpx"; controller = "no-control"; note = "무제어 · 램프 병목 망 — 새 기준선" },
  @{ name = "ctl_base_x18_20260902"; tuning = "evaluation/configs/canon_farbn_d00_x18_20260901.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18_rampbn.inpx"; controller = "wu-link"; note = "대조군 — 유출 스위치 OFF (정본 승격분은 공통)" },
  @{ name = "ctl_outflow_x18_20260902"; tuning = "evaluation/configs/canon_outflow_d00_x18_20260901.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18_rampbn.inpx"; controller = "wu-link"; note = "실험군 — Sigma_nin 동역학 도착 + 게이트 이탈 차감 + 램프행 spillback" }
)
