<#
2026-08-30. 램프 합류셀 보정 + METANET 동역학 4항 적합. 원본 망.
...
$arms = @(
  @{ name = "canon_mergefix_20260830"; tuning = "evaluation/configs/canon_mergefix_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e.inpx"; note = "램프 합류셀 보정 R_F_W 4->5 (+VSL 격자 10단위) — 대조 fdfit3 4657.8" },
  @{ name = "canon_mergedyn_20260830"; tuning = "evaluation/configs/canon_mergedyn_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e.inpx"; note = "위 + 동역학 4항 tau7/nu48/kappa25/delta17.3 — 대조 mergefix" }
)
