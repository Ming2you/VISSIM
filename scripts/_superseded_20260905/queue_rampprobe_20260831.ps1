<#
2026-08-31. 램프 병목을 만들 수 있는가 — 무제어 2런.
...
$arms = @(
  @{ name = "nc_lcd200_20260831"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_lcd200.inpx"; note = "무제어 · 램프 lnChgDist 1000->200 — 대조 nocontrolstep 4819.4" },
  @{ name = "nc_rampmax_20260831"; tuning = "evaluation/configs/canon_nolencap_20260828.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_rampmax.inpx"; note = "무제어 · 경로 relFlow 로 램프 몫 최대 — 도시부 분포가 바뀌므로 이 망의 새 기준선" }
)
