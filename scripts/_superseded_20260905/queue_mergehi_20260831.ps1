...
$arms = @(
  @{ name = "canon_mergefix_x18_20260831"; tuning = "evaluation/configs/canon_mergefix_x18_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18_dsd110.inpx"; note = "x1.8 · 합류셀 보정 R_F_W 4->5 (+VSL 10단위, 110 분포 신설) — 무제어 6692.0 / 기존제어 6699.3" },
  @{ name = "canon_mergedyn_x18_20260831"; tuning = "evaluation/configs/canon_mergedyn_x18_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18_dsd110.inpx"; note = "x1.8 · 위 + 동역학 4항 tau7/nu48/kappa25/delta17.3 — 무제어 6692.0 / 기존제어 6699.3" },
  @{ name = "canon_mergefix_x22_20260831"; tuning = "evaluation/configs/canon_mergefix_x22_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22_dsd110.inpx"; note = "x2.2 · 합류셀 보정 R_F_W 4->5 (+VSL 10단위, 110 분포 신설) — 무제어 6958.9 / 기존제어 7035.7" },
  @{ name = "canon_mergedyn_x22_20260831"; tuning = "evaluation/configs/canon_mergedyn_x22_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22_dsd110.inpx"; note = "x2.2 · 위 + 동역학 4항 tau7/nu48/kappa25/delta17.3 — 무제어 6958.9 / 기존제어 7035.7" }
)
