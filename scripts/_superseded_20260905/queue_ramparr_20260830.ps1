<#
2026-08-30. 램프별 실측 통과시간을 넣는다 — 모델 ramp_arrival 을 플랜트에 맞춘다.
...
$arms = @(
  @{ name = "canon_fd3sw18_ramparr_20260830"; tuning = "evaluation/configs/canon_fd3sw18_ramparr_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18.inpx"; note = "x1.8 · 램프별 실측 통과시간 — 대조 6699.3 / 무제어 6692.0" },
  @{ name = "canon_fd3sw22_ramparr_20260830"; tuning = "evaluation/configs/canon_fd3sw22_ramparr_20260830.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22.inpx"; note = "x2.2 · 〃 — 대조 7035.7 / 무제어 6958.9" }
)
