<#
2026-08-31. 같은 세 수정을 **붕괴 구간**에서 잰다 (x1.8 · x2.2).
...
$arms = @(
  @{ name = "canon_ramgnedyn_x18_20260831"; tuning = "evaluation/configs/canon_ramgnedyn_x18_20260831.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x18.inpx"; note = "x1.8 · 도착교정+미터링GNE+동역학4항 — 무제어 6692.0 / 기존제어 6699.3" },
  @{ name = "canon_ramgnedyn_x22_20260831"; tuning = "evaluation/configs/canon_ramgnedyn_x22_20260831.json"; network = "network/real_world_gaepo_modi/modi_eval_userfix_20260814e_fwsweep_x22.inpx"; note = "x2.2 · 도착교정+미터링GNE+동역학4항 — 무제어 6958.9 / 기존제어 7035.7" }
)
