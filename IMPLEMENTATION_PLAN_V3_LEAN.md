...
> 산출물은 `outputs/experiment_matrix_v3.json`, 봉인 `5d61830916182664`.
>
> | 항목 | 값 |
> |---|---|
> | 전체 셀 | 2,880 |
> | 실행 대상 | 2,160 |
> | BLOCKED (offset, N4-6 대기) | 720 |
> | 총 시뮬레이션 시간 | **1,325 h** |
> | 제어 결정 | **79,488 회** |
>
> 60배속이어도 순수 VISSIM 벽시계가 22시간이다. 여기에 **결정마다 solve** 가 붙는다.
> 현재 solve 는 300초대이므로 79,488 × 300 s ≈ **6,600 시간(276일)** 이다.
>
> **따라서 N8-4 를 먼저 끝내지 않으면 N9 는 시작할 수 없다.** 계획 순서상 N9 가 뒤이지만
> 의존은 반대 방향이 아니라 이 방향이다. 순서를 뒤집지 마라.
>
